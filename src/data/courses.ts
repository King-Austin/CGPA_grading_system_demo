...
export interface Course {
  ...
  year: number;
  semester: number;
  category?: 'core' | 'elective' | 'faculty';
}

export const ALL_COURSES: Course[] = [
  // First Year - First Semester
  { code: 'GSS 101', title: 'Use of English', creditUnit: 2, year: 1, semester: 1, category: 'core' },
  { code: 'GSS 105', title: 'Humanities', creditUnit: 2, year: 1, semester: 1, category: 'core' },
  { code: 'GSS 107', title: 'Nigerian Peoples and Culture', creditUnit: 2, year: 1, semester: 1, category: 'core' },
  ...
  { code: 'BUS 101', title: 'Introduction to Business', creditUnit: 2, year: 1, semester: 1, category: 'elective' },
  { code: 'FEG 101', title: 'Engineering Mathematics I', creditUnit: 3, year: 1, semester: 1, category: 'core' },

  // First Year - Second Semester
  { code: 'GSS 102', title: 'Use of English II', creditUnit: 2, year: 1, semester: 2, category: 'core' },
  { code: 'GSS 103', title: 'Introduction to Logic and Philosophy', creditUnit: 2, year: 1, semester: 2, category: 'core' },
  ...
  { code: 'ICH 112', title: 'Basic Practical Chemistry', creditUnit: 1, year: 1, semester: 2, category: 'core' },
  { code: 'FEG 102', title: 'Engineering Mathematics II', creditUnit: 3, year: 1, semester: 2, category: 'core' },
  { code: 'FEG 103', title: 'Circuit Theory I', creditUnit: 3, year: 1, semester: 2, category: 'core' },

  // Second Year - First Semester
  { code: 'MAT 202', title: 'Elementary Differential Equations', creditUnit: 3, year: 2, semester: 1, category: 'core' },
  { code: 'CSE 202', title: 'Computer Programming II', creditUnit: 2, year: 2, semester: 1, category: 'core' },
  { code: 'BUS 204', title: 'Principles Management', creditUnit: 2, year: 2, semester: 1, category: 'elective' },
  { code: 'FEG 202', title: 'Applied Electricity II', creditUnit: 3, year: 2, semester: 1, category: 'core' },
  { code: 'FEG 212', title: 'Applied Mechanics II (Dynamics)', creditUnit: 2, year: 2, semester: 1, category: 'core' },
  { code: 'FEG 214', title: 'Engineering Drawing II', creditUnit: 3, year: 2, semester: 1, category: 'core' },
  { code: 'FEG 215', title: 'Strength of Materials I', creditUnit: 2, year: 2, semester: 1, category: 'core' },
  { code: 'FEG 242', title: 'Thermodynamics', creditUnit: 2, year: 2, semester: 1, category: 'core' },
  { code: 'FEG 280', title: 'Engineers in Society', creditUnit: 2, year: 2, semester: 1, category: 'core' },
  { code: 'FEG 282', title: 'Workshop Practice II', creditUnit: 2, year: 2, semester: 1, category: 'core' },

  // Second Year - Second Semester
  { code: 'FEG 372', title: 'Instrumentation and Measurement', creditUnit: 2, year: 2, semester: 2, category: 'faculty' },
  { code: 'ELE 344', title: 'Electro-Mechanical Devices and Machine 2', creditUnit: 2, year: 2, semester: 2, category: 'core' },
  { code: 'ELE 312', title: 'Circuit Theory 2', creditUnit: 3, year: 2, semester: 2, category: 'core' },
  { code: 'ECE 326', title: 'Physical Electronics', creditUnit: 2, year: 2, semester: 2, category: 'core' },
  { code: 'ECE 328', title: 'Electronic Devices and Circuits 2', creditUnit: 3, year: 2, semester: 2, category: 'core' },
  { code: 'ELE 382', title: 'Feedback and Control Systems', creditUnit: 2, year: 2, semester: 2, category: 'core' },
  { code: 'ELE 342', title: 'Electrodynamics', creditUnit: 2, year: 2, semester: 2, category: 'core' },
  { code: 'ECE 322', title: 'Telecommunications 2', creditUnit: 2, year: 2, semester: 2, category: 'core' },
  { code: 'ECE 334', title: 'Digital System Design 2', creditUnit: 2, year: 2, semester: 2, category: 'core' },

  // Third Year - First Semester (from the third image)
