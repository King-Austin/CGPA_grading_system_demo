...
export const ALL_COURSES: Course[] = [
  ...
  { code: 'MAT202', title: 'Elementary Mathematics', creditUnit: 3, year: 2, semester: 1, category: 'faculty' },
  { code: 'FEG202', title: 'Basic Electricity 2', creditUnit: 3, year: 2, semester: 1, category: 'faculty' },
  { code: 'FEG212', title: 'Applied Mechanics 2', creditUnit: 2, year: 2, semester: 1, category: 'faculty' },
  { code: 'FEG242', title: 'Thermodynamics', creditUnit: 2, year: 2, semester: 1, category: 'faculty' },
  { code: 'FEG282', title: 'Workshop Practice 2', creditUnit: 2, year: 2, semester: 1, category: 'faculty' },
  { code: 'FEG215', title: 'Strength Of Material', creditUnit: 3, year: 2, semester: 1, category: 'faculty' },
  { code: 'FEG214', title: 'Engineering Drawing 2', creditUnit: 2, year: 2, semester: 1, category: 'faculty' },
  { code: 'BUS204', title: 'Principles Of Management', creditUnit: 2, year: 2, semester: 1, category: 'faculty' },
  { code: 'FEG280', title: 'Engineers In Society', creditUnit: 2, year: 2, semester: 1, category: 'faculty' },
  { code: 'CSC202', title: 'Computer Programming 2', creditUnit: 2, year: 2, semester: 1, category: 'faculty' },

  // YEAR TWO (200 LEVEL) - Second Semester
  { code: 'FEG201', title: 'Basic Electricity 1', creditUnit: 3, year: 2, semester: 2, category: 'faculty' },
  { code: 'FEG211', title: 'Applied Mechanics', creditUnit: 2, year: 2, semester: 2, category: 'faculty' },
  { code: 'FEG250', title: 'Principles Of Material', creditUnit: 3, year: 2, semester: 2, category: 'faculty' },
  { code: 'FEG221', title: 'Fluid Mechanics', creditUnit: 2, year: 2, semester: 2, category: 'faculty' },
  { code: 'FEG213', title: 'Engineering Drawing', creditUnit: 2, year: 2, semester: 2, category: 'faculty' },
  { code: 'ICH221', title: 'Applied Chemistry', creditUnit: 2, year: 2, semester: 2, category: 'faculty' },
  { code: 'CSC201', title: 'Computer Programming 1', creditUnit: 2, year: 2, semester: 2, category: 'faculty' },
  { code: 'MAT201', title: 'Linear Algebra', creditUnit: 3, year: 2, semester: 2, category: 'faculty' },
  { code: 'FEG281', title: 'Workshop Practice', creditUnit: 2, year: 2, semester: 2, category: 'faculty' },
  { code: 'CDS200', title: 'Carrier Development Skill', creditUnit: 0, year: 2, semester: 2, category: 'faculty' },
